...
.candidate-switcher{display:flex;gap:7px;overflow-x:auto;padding:3px}.candidate-switcher button{flex:0 0 auto;min-height:48px;padding:7px 10px;border: none;border-radius: 12px;color:var(--muted);background: transparent;font-size:.7rem;font-weight:800}.candidate-switcher button small{display:block;margin-top:3px;color:var(--subtle);font-size:.6rem}.candidate-switcher button.active{border-color:var(--accent);color:var(--accent);background: var(--surface-2);box-shadow: none;align-items:center;justify-content:space-between;gap:18px}.review-policy{display:flex;justify-content:space-between;align-items:center;gap:24px}.batch-copy span,.batch-copy strong,.batch-copy small{display:block}.batch-copy span{color:var(--subtle);font-size:.68rem;font-weight:800}.batch-copy strong{margin:4px 0;font-size:.9rem}.batch-copy small{max-width:760px;color:var(--muted);font-size:.68rem;line-height:1.5}.policy-stats{display:flex;gap:8px}.policy-stats span{min-width:112px;padding:10px;border: none;border-radius: 12px;color:var(--muted);background: var(--surface-2);font-size:.68rem}.policy-stats b{display:block;margin-bottom:4px;color:var(--text);font-size:1.05rem}
