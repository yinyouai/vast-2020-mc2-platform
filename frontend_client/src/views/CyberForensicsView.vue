...
<style scoped>
.verdict-page{gap:22px}.verdict-hero{display:grid;grid-template-columns:minmax(0,1fr) 150px minmax(360px,.8fr);align-items:center;gap:24px;padding:28px;border:1px solid #e7d3a2;border-radius:16px;background:linear-gradient(120deg,#fffdf7,#f5f9ff 56%,#eef8f5);box-shadow:var(--shadow)}
.verdict-copy{min-width:0}.verdict-copy h3{margin:3px 0 6px;font-size:2.3rem}.verdict-copy p{display:block!important;margin:0;color:var(--muted)}.member-line{display:flex;flex-wrap:wrap;gap:5px;margin-top:13px}.member-line span{padding:5px 7px;border:1px solid var(--border);border-radius:5px;background:#fff;font-size:.7rem}
.score-ring{display:grid;place-items:center;width:132px;aspect-ratio:1;border-radius:50%;background:conic-gradient(#d99522 var(--score),#e5ebf1 0);position:relative}.score-ring:after{content:"";position:absolute;inset:12px;border-radius:50%;background:#fff}.score-ring div{position:relative;z-index:1;text-align:center}.score-ring strong,.score-ring span{display:block}.score-ring strong{font-size:2rem}.score-ring span{color:var(--muted);font-size:.7rem}
.verdict-kpis{display:grid;grid-template-columns:1fr 1fr;gap:8px}.verdict-kpis article{padding:11px;border:1px solid var(--border);border-radius:7px;background:rgba(255,255,255,.82)}.verdict-kpis span,.verdict-kpis b{display:block}.verdict-kpis span{color:var(--subtle);font-size:.68rem}.verdict-kpis b{margin-top:5px;font-size:1rem}
