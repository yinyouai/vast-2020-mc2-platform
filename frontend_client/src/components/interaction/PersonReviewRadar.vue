...
<style scoped>
.review-radar{padding:18px;border: none;border-radius: 12px;background: transparent;box-shadow: none;align-items:flex-start;justify-content:space-between;gap:20px}.radar-header h4{margin:6px 0 4px;font-size:1.12rem}.radar-header p{max-width:720px;margin:0;color:var(--muted);font-size:.78rem;line-height:1.55}
.live-label{display:flex;align-items:center;gap:7px;color: var(--success);font-size:.7rem;font-weight:900;letter-spacing:.08em}.live-label i{width:8px;height:8px;border-radius:50%;background:var(--success);box-shadow: none;animation:pulse 1.8s ease-out infinite}
...
.radar-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin:16px 0 12px}.radar-summary div { display:flex; align-items:baseline; gap:8px; padding:10px 0; border:none; background: transparent; }.radar-summary strong{font-size:1.22rem;font-variant-numeric:tabular-nums}.radar-summary span{color:var(--muted);font-size:.72rem}
.priority-list{display:grid;gap:7px}.priority-row { display:grid; grid-template-columns:38px minmax(0,1fr) auto 68px; align-items:center; gap:12px; width:100%; min-height:64px; padding:10px 0; border-bottom: 1px solid rgba(255, 255, 255, 0.05); color:var(--text); text-align:left; background: transparent; cursor:pointer; }.priority-row:hover,.priority-row:focus-visible{transform:translateY(-1px);border-color: rgba(255,255,255,0.05);box-shadow: none;outline:none}.priority-high{--risk-color:var(--danger);--risk-soft:rgba(244, 63, 94, 0.15)}.priority-medium{--risk-color:var(--warning);--risk-soft:rgba(245, 158, 11, 0.15)}.priority-low{--risk-color:var(--success);--risk-soft:rgba(16, 185, 129, 0.15)}
.priority-rank{display:grid;place-items:center;width:34px;height:34px;border-radius: 12px;color:var(--risk-color);background:var(--risk-soft);font-size:.76rem;font-weight:900;font-variant-numeric:tabular-nums}.person-copy{min-width:0}.person-title{display:flex;align-items:center;gap:8px}.person-title strong{font-size:.9rem}.person-title em{padding:3px 6px;border-radius: 12px;color:var(--risk-color);background:var(--risk-soft);font-size:.63rem;font-style:normal;font-weight:800}
.risk-track{display:block;overflow:hidden;height:4px;margin:8px 0 6px;border-radius: 12px;background:#edf0f4}.risk-track i{display:block;width:100%;height:100%;border-radius:inherit;background:var(--risk-color);transform-origin:left center;transition:transform 240ms ease}.reason-line{display:block;overflow:hidden;color:var(--muted);font-size:.7rem;text-overflow:ellipsis;white-space:nowrap}
...
.score-legend{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-top:12px}.score-legend details{color:var(--muted);font-size:.7rem}.score-legend summary{min-height:36px;padding:9px 0;font-weight:800;cursor:pointer}.score-legend details span{display:block;margin:5px 0}.expand-button{min-height:38px;padding:0 12px;border: none;border-radius: 12px;color:var(--text);background: transparent;font-size:.72rem;font-weight:800}.radar-empty{padding:28px;color:var(--muted);text-align:center}
@keyframes pulse{0%{box-shadow: none;grid-template-columns:repeat(4,1fr)}}
@media(max-width:620px){.radar-header{display:block}.sync-copy{margin-top:10px;text-align:left}.radar-summary{grid-template-columns:1fr}.priority-row { display:grid; grid-template-columns:38px minmax(0,1fr) auto 68px; align-items:center; gap:12px; width:100%; min-height:64px; padding:10px 0; border-bottom: 1px solid rgba(255, 255, 255, 0.05); color:var(--text); text-align:left; background: transparent; cursor:pointer; }.signal-grid{grid-template-columns:repeat(2,1fr)}}
</style>
