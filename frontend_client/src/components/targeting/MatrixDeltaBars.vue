...
.series-legend{display:flex;flex-wrap:wrap;gap:12px;color:var(--muted);font-size:.68rem;font-weight:800}.series-legend span{display:flex;align-items:center;gap:6px}.series-legend i{width:16px;height:7px;border-radius:3px}.series-legend i.raw{background:#9cb5cf}.series-legend i.corrected{background:#24956f}
.comparison-detail{margin-top:8px;padding:12px;border:1px solid var(--border);border-radius:8px;background:#f7f9fc}.comparison-detail>header{display:flex;align-items:center;justify-content:space-between;gap:10px}.comparison-detail header span,.comparison-detail header strong{display:block}.comparison-detail header span{color:var(--subtle);font-size:.65rem;font-weight:800}.comparison-detail header strong{margin-top:4px;font-size:.9rem}.delta-value{padding:5px 8px;border-radius:5px;color:var(--muted);background:#e9eef4;font-size:.75rem;font-weight:900}.delta-value.positive{color:#187553;background:#eaf7f1}.delta-value.negative{color:#a94141;background:#fcecec}
.owner-columns{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:10px}.owner-columns section{min-width:0;padding:9px;border:1px solid var(--border);border-radius:7px;background:#fff}.owner-columns section>div{display:flex;align-items:center;justify-content:space-between;gap:8px}.owner-columns span{color:var(--muted);font-size:.7rem;font-weight:800}.owner-columns b{font-size:.72rem}.owner-columns p{display:flex!important;flex-wrap:wrap;gap:5px;margin:8px 0 0}.owner-columns button{min-height:28px;padding:0 7px;border:1px solid var(--border);border-radius:5px;color:var(--text);background:#f7f9fc;font-size:.65rem;font-weight:700}.owner-columns button:hover,.owner-columns button:focus-visible{border-color:var(--accent);color:var(--accent)}.owner-columns small{display:block;margin-top:8px;color:var(--subtle);font-size:.68rem}
