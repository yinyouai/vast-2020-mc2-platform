...
<style scoped>
.section-kicker{color:var(--subtle);font-size:.7rem;font-weight:800}.provenance-flow{display:grid;gap:8px}.provenance-flow article{display:grid;grid-template-columns:38px 1fr;align-items:center;gap:10px;padding:9px;border-left:3px solid var(--accent);background:#f8fbff}.provenance-flow article>span{display:grid;place-items:center;width:34px;height:34px;border-radius:6px;color:var(--accent);background:#e7f0ff;font-weight:900}.provenance-flow strong,.provenance-flow small{display:block}.provenance-flow small{margin-top:3px;color:var(--muted);font-size:.7rem}
.final-statement{margin-top:12px;padding:14px;border:1px solid #ead6a8;border-radius:7px;background:#fff9e9}.final-statement span{color:#8a5a0a;font-size:.7rem;font-weight:800}.final-statement strong{display:block;margin:5px 0;font-size:1.3rem}.final-statement p{display:block!important;margin:0;color:var(--muted);font-size:.72rem;line-height:1.5}
</style>
