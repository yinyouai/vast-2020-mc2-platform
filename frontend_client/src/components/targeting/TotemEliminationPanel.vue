...
.bulk-actions{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-bottom:10px}.bulk-actions button{min-height:38px;border: none;border-radius: 12px;color:var(--text);background: var(--surface-3);font-size:.72rem;font-weight:800}
.filter-list{display:grid;gap:6px;max-height:420px;overflow:auto}.filter-row{display:grid;grid-template-columns:22px 1fr;align-items:center;gap:7px;padding:7px;border: none;border-radius: 12px;background: var(--surface)}.filter-row.is-selected{border-color:var(--accent);box-shadow: none;background: var(--surface-3)}
...
.filter-summary{margin-top:10px;padding:12px;border: none;border-radius: 12px;background:#f3f8ff}.filter-summary span{color:var(--subtle);font-size:.68rem;font-weight:800}.filter-summary strong{display:block;margin:5px 0}.filter-summary p{display:block!important;margin:0;color:var(--muted);font-size:.74rem;line-height:1.5}
</style>
