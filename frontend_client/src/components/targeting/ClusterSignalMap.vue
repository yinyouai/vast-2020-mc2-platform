...
.legend{display:flex;flex-wrap:wrap;gap:12px;color:var(--muted);font-size:.68rem;font-weight:800}.legend span{display:flex;align-items:center;gap:6px}.legend-dot{width:9px;height:9px;border-radius:50%;background:#dbe6f2}.legend-dot.exact{background:var(--accent)}.legend-dot.winner{background:#d99522}
.plot-shell{width:100%;overflow-x:auto;border: none;border-radius: 12px;background: var(--surface)}.distribution-plot{display:block;width:100%;min-width:590px;height:auto;min-height:320px}.plot-background{fill: var(--surface-2)}.target-band{fill:rgba(47,125,246,.06);stroke:rgba(47,125,246,.16);stroke-dasharray:5 5}.grid-line{stroke:rgba(53,89,138,.12);stroke-dasharray:4 5}.grid-line.vertical{stroke-dasharray:2 6}.axis-label{fill: var(--subtle);font-size:11px;font-weight:700}.axis-title{fill: var(--muted);font-size:12px;font-weight:800}.target-label{fill:var(--accent);font-size:10px;font-weight:900}
.candidate-point{cursor:pointer;outline:none}.point-hit-area{fill:transparent}.point-circle{fill:#35a8c8;stroke: var(--surface-3);stroke-width:3;filter:drop-shadow(0 5px 7px rgba(48,78,114,.18));transition:fill 160ms ease,stroke 160ms ease,transform 160ms ease;transform-box:fill-box;transform-origin:center}.candidate-point.is-exact .point-circle{fill:var(--accent)}.candidate-point.is-winner .point-circle{fill:#d99522}.candidate-point.is-selected .point-circle{stroke:#17324d;stroke-width:4;transform:scale(1.12)}.candidate-point:hover .point-circle,.candidate-point:focus-visible .point-circle{stroke:#17324d;transform:scale(1.12)}.point-label{fill: var(--text);font-size:10px;font-weight:900;opacity:0;pointer-events:none}.candidate-point:hover .point-label,.candidate-point:focus-visible .point-label,.candidate-point.is-selected .point-label,.candidate-point.is-winner .point-label{opacity:1}
.candidate-index{display:flex;flex-wrap:wrap;gap:6px;margin-top:10px}.candidate-index button{display:inline-flex;align-items:center;gap:6px;min-height:34px;padding:0 9px;border: none;border-radius: 12px;color:var(--muted);background: var(--surface);font-size:.67rem;font-weight:800}.candidate-index button:hover,.candidate-index button:focus-visible,.candidate-index button.active{border-color:var(--accent);color:var(--accent);background: var(--surface-glow)}.candidate-index i{width:7px;height:7px;border-radius:50%;background:#35a8c8}.candidate-index i.winner{background:#d99522}
.selected-candidate{display:grid;grid-template-columns:1.4fr repeat(3,1fr);gap:8px;margin-top:12px}.selected-candidate>div{min-width:0;padding:10px 11px;border: none;border-radius: 12px;background: var(--surface)}.selected-candidate span,.selected-candidate strong{display:block}.selected-candidate span{color:var(--subtle);font-size:.64rem;font-weight:800}.selected-candidate strong{overflow:hidden;margin-top:5px;font-size:.8rem;text-overflow:ellipsis;white-space:nowrap}.selected-main{border-color:rgba(47,125,246,.22)!important;background: var(--surface-glow)!important}.selected-main strong{color:var(--accent)}
