...
.detection-progress>div{display:flex;justify-content:space-between;color:var(--muted);font-size:.72rem}.detection-progress i{display:block;height:7px;margin-top:8px;border-radius:4px;background:#dfe7ef;overflow:hidden}.detection-progress em{display:block;height:100%;background:#24956f}
